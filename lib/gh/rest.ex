defmodule GH.REST do
  ...
  where `reason` is a `GH.Error` for an API error response or a `Req` exception for
  a transport failure. `meta` is a `GH.REST.Meta` struct carrying the status,
  ...
  ## Examples
      ...
      GH.REST.get(client, "/repos/elixir-lang/elixir")
      GH.REST.get(client, "/repos/o/r/issues", params: [state: "open"])
