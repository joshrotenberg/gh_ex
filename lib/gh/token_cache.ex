defmodule GH.TokenCache do
  ...
  every request, an installation client (see `GH.App.installation/3`) resolves its
  token through a cache implementing this behaviour. `GH.TokenCache.ETS` is the
